...
final class DefaultNetworkService {
    ...
    init(
        ...
        logger: NetworkErrorLogger = DefaultNetworkErrorLoger()
    ) {
        self.config = config
...
final class DefaultNetworkErrorLoger: NetworkErrorLogger {
    init() { }
...
extension NetworkError {
    var isNotFountError: Bool { return hasStatusCode(404) }
